"""
Django settings for yiqibnb project.
...
WSGI_APPLICATION = 'yiqibnb.wsgi.application'
...
SMS_ACCESS_KEY = 'LTAI4NbBQ3MV3E2Q'
SMS_SECRET = 'nXhICqRnhxJXbm8KO64owJQJHEMLdX'
SMS_SIGN_NAME = '祁域科技'
